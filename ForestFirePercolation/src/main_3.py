...
def main():
    ...
    density = [0.595,0.596,0.597,0.598,0.599,0.600,0.601,0.602,0.603,0.604,0.605,0.606,0.607,0.608,0.609,0.610]
    test_wind = "Wind"
    env_indices = [0.75]
    ...
    size = [100,250,500,750,1000]
    density = [0.59,0.591, 0.592, 0.593, 0.594, 0.595, 0.596, 0.597, 0.598, 0.599, 0.600, 0.601, 0.602, 0.603, 0.604, 0.605]
    test_wind = "No Wind"
    env_indices = [1.0]
    ...
    size = [100,250,500,750,1000]
    density = [0.54,0.541, 0.542,0.543,0.544, 0.545, 0.546, 0.547, 0.548, 0.549, 0.550, 0.551, 0.552, 0.553, 0.554,0.555]
    test_wind = "Wind"
    env_indices = [1.0]
    plant_tree_proporitons = [0.0]
    tree_burn_times = [1]
    ...
    size = [100,250,500,750,1000]
    density = [0.73, 0.731,0.732, 0.733, 0.734, 0.735, 0.736, 0.737, 0.738, 0.739, 0.740, 0.741, 0.742,0.743,0.744,0.745]
    test_wind = "No Wind"
    env_indices = [0.75]
    plant_tree_proporitons = [0.0]
    tree_burn_times = [1]
